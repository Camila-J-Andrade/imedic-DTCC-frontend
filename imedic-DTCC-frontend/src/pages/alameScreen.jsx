...
import { View, Text, StyleSheet, SafeAreaView, ScrollView, TouchableOpacity, Image, TextInput, Alert, Platform } from 'react-native';
...
export default function AlarmScreen() {
	...
	const createAlarmEvent = async () => {
		try {
			...
			await fetch('http://35.247.252.179:3333/alarmes', {
				method: 'POST',
				headers: {
